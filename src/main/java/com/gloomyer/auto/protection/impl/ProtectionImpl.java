...
public class ProtectionImpl implements Protection {
    ...
    private List<ProtectionTask> protectionTasks;
    ...
    public void protection(String uploadMethod,
        ...
        this.protectionTasks = new ArrayList<>();
    ...
    private void protection() {
        for (ProtectionTask task : protectionTasks) {
    ...
    private void upload() {
        ...
        for (File file : files) {
            if (file.isFile() || file.getName().endsWith(".apk")) {
                ...
                protectionTasks.add(new ProtectionTask(
                        file,
                        fileUrl,
                        protectionSecretId,
                        protectionSecretKey
